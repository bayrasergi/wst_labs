...
public interface ShipWebService {
    ...
    public boolean deleteShip(
        ...
        int shipId) throws ShipIdNotFoundException;
    ...
    public boolean updateShip(
        ...
        Ship shipEdits) throws ShipTypeNotFoundException, ShipIncorrectLevelException, ShipIncorrectRarityException, ShipIncorrectNationException;
    ...
    public int createShip(
        ...
        Ship ship) throws ShipNullFieldException, ShipTypeNotFoundException, ShipIncorrectLevelException, ShipIncorrectRarityException, ShipIncorrectNationException;
